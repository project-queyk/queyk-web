  ...
  return (
    <div className="mx-6 my-80 grid items-center justify-center gap-2 md:gap-3">
      ...
      {error === "AccessDenied" && (
        <>
          <p className="text-muted-foreground text-sm font-medium text-balance break-words md:text-base">
            Access restricted. You must use your official Immaculada Concepcion
            College email to sign in.
          </p>
          <Button
      ...
      {error === "Verification" && (
        <>
          <p className="text-muted-foreground text-sm font-medium text-balance break-words md:text-base">
            We couldn&apos;t verify your email address. Please check your inbox
            for a verification email or try signing in again.
          </p>
